...
export * as AccessCodeModel from './accessCode.model.js';
export * as CodeRequestModel from './codeRequest.model.js';
export * as QuizModel from './quiz.model.js';
export * as QuestionModel from './question.model.js';
export * as OptionModel from './option.model.js';
export * as QuizResultModel from './quizResult.model.js';
