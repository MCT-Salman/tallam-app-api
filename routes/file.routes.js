...
import { idParam, courseLevelIdParam,fileCreateRules, fileUpdateRules, listQueryRules } from "../validators/file.validators.js";
...
// Admin endpoints
r.get("/admin/courselevel/:courseLevelId/files", requireAuth, requireRole(["ADMIN", "SUBADMIN"]),validate(courseLevelIdParam), validate(listQueryRules), adminListFiles);
...
r.get("/file/:id", requireAuth, requireRole(["STUDENT"]), validate(idParam), publicGetFile);
