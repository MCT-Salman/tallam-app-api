...
router.post(
  ...
  validate(generateCodesRules),
  AccessCodeController.adminGenerateCodes
);
...
router.get(
  ...
  AccessCodeController.adminGetCourseCodes
);
...
router.post(
  ...
  requireAuth,
  requireRole(['STUDENT']),
  validate(activateCodeRules),
  AccessCodeController.studentActivateCode
);
